...
func TestList(t *testing.T) {
	...
	httpmock.RegisterResponder("GET", "https://schematics.cloud.ibm.com/v1/workspaces",
		func(req *http.Request) (*http.Response, error) {
			...
			// export TOKEN=$(curl -s -k -X POST --header "Content-Type: application/x-www-form-urlencoded"  --data-urlencode "grant_type=urn:ibm:params:oauth:grant-type:apikey"  --data-urlencode "apikey=$IC_API_KEY" "https://iam.cloud.ibm.com/identity/token" | jq -r .access_token)
